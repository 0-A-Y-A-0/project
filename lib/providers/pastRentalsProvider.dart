...
class PastRentalsHistory extends AsyncNotifier<List<Rental>> {
  @override
  Future<List<Rental>> build() async {
    final dio = ref.read(dioProvider);

    final response = await dio.get('/user/my_past_rentals');
...
final PastRentalsProvider =
AsyncNotifierProvider<PastRentalsHistory, List<Rental>>(
  PastRentalsHistory.new,
);
