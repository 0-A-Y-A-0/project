...
class RequestsNotifier extends AsyncNotifier<List<Rental>> {
  @override
  Future<List<Rental>> build() async {
    final dio = ref.read(dioProvider);

    print ("TO THE BACK ----------------------- requests ");

    final response = await dio.get('/user/rentals');
...
AsyncNotifierProvider<RequestsNotifier, List<Rental>>(
